# Idea 070: EURNZD ATR trailing exit study

## Summary

Document a PyP Quant strategy candidate for EURNZD on 5m candles using a LightGBM approach focused on ATR trailing exit study.

## Market Hypothesis

EURNZD may show repeatable behavior when ATR trailing exit study conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
