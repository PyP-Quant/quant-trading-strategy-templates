# Idea 065: USDCAD Bollinger squeeze expansion

## Summary

Document a PyP Quant strategy candidate for USDCAD on 1m candles using a RandomForestClassifier approach focused on Bollinger squeeze expansion.

## Market Hypothesis

USDCAD may show repeatable behavior when Bollinger squeeze expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
