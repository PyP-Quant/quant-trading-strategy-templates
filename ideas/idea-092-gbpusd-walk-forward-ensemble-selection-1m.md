# Idea 092: GBPUSD Walk-forward ensemble selection

## Summary

Document a PyP Quant strategy candidate for GBPUSD on 1m candles using a LogisticRegression approach focused on walk-forward ensemble selection.

## Market Hypothesis

GBPUSD may show repeatable behavior when walk-forward ensemble selection conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
