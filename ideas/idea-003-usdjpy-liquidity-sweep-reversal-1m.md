# Idea 003: USDJPY Liquidity sweep reversal

## Summary

Document a PyP Quant strategy candidate for USDJPY on 1m candles using a LogisticRegression approach focused on liquidity sweep reversal.

## Market Hypothesis

USDJPY may show repeatable behavior when liquidity sweep reversal conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
