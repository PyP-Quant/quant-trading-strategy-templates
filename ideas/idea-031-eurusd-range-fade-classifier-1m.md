# Idea 031: EURUSD Range fade classifier

## Summary

Document a PyP Quant strategy candidate for EURUSD on 1m candles using a LogisticRegression approach focused on range fade classifier.

## Market Hypothesis

EURUSD may show repeatable behavior when range fade classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
