# Idea 032: GBPUSD News-window risk gate

## Summary

Document a PyP Quant strategy candidate for GBPUSD on 1m candles using a LogisticRegression approach focused on news-window risk gate.

## Market Hypothesis

GBPUSD may show repeatable behavior when news-window risk gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
