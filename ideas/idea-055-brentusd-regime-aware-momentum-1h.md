# Idea 055: BRENTUSD Regime-aware momentum

## Summary

Document a PyP Quant strategy candidate for BRENTUSD on 1h candles using a statsmodels ARIMA approach focused on regime-aware momentum.

## Market Hypothesis

BRENTUSD may show repeatable behavior when regime-aware momentum conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
