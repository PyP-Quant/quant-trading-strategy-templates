# Idea 101: BTCUSDT Multi-timeframe trend filter

## Summary

Document a PyP Quant strategy candidate for BTCUSDT on 15m candles using a LightGBM approach focused on multi-timeframe trend filter.

## Market Hypothesis

BTCUSDT may show repeatable behavior when multi-timeframe trend filter conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
