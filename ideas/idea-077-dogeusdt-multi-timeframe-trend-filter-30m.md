# Idea 077: DOGEUSDT Multi-timeframe trend filter

## Summary

Document a PyP Quant strategy candidate for DOGEUSDT on 30m candles using a ExtraTreesClassifier approach focused on multi-timeframe trend filter.

## Market Hypothesis

DOGEUSDT may show repeatable behavior when multi-timeframe trend filter conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
