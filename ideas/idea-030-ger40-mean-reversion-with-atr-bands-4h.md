# Idea 030: GER40 Mean reversion with ATR bands

## Summary

Document a PyP Quant strategy candidate for GER40 on 4h candles using a rule-based baseline approach focused on mean reversion with ATR bands.

## Market Hypothesis

GER40 may show repeatable behavior when mean reversion with ATR bands conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
