# Idea 085: BRENTUSD Adaptive threshold classifier

## Summary

Document a PyP Quant strategy candidate for BRENTUSD on 1h candles using a statsmodels ARIMA approach focused on adaptive threshold classifier.

## Market Hypothesis

BRENTUSD may show repeatable behavior when adaptive threshold classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
