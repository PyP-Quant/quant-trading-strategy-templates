# Idea 019: AVAXUSDT Calendar seasonality overlay

## Summary

Document a PyP Quant strategy candidate for AVAXUSDT on 30m candles using a SGDClassifier approach focused on calendar seasonality overlay.

## Market Hypothesis

AVAXUSDT may show repeatable behavior when calendar seasonality overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
