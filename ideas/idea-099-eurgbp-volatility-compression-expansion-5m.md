# Idea 099: EURGBP Volatility compression expansion

## Summary

Document a PyP Quant strategy candidate for EURGBP on 5m candles using a HistGradientBoostingClassifier approach focused on volatility compression expansion.

## Market Hypothesis

EURGBP may show repeatable behavior when volatility compression expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
