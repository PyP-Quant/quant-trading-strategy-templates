# Idea 060: GER40 Opening range continuation

## Summary

Document a PyP Quant strategy candidate for GER40 on 4h candles using a rule-based baseline approach focused on opening range continuation.

## Market Hypothesis

GER40 may show repeatable behavior when opening range continuation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
