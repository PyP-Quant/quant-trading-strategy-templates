# Idea 027: COPPERUSD Volatility compression expansion

## Summary

Document a PyP Quant strategy candidate for COPPERUSD on 4h candles using a statsmodels ARIMA approach focused on volatility compression expansion.

## Market Hypothesis

COPPERUSD may show repeatable behavior when volatility compression expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
...
- Predict whether the forward 4h move exceeds an ATR-normalized threshold.
