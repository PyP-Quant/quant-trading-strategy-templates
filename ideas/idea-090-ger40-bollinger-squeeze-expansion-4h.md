# Idea 090: GER40 Bollinger squeeze expansion

## Summary

Document a PyP Quant strategy candidate for GER40 on 4h candles using a rule-based baseline approach focused on Bollinger squeeze expansion.

## Market Hypothesis

GER40 may show repeatable behavior when Bollinger squeeze expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
