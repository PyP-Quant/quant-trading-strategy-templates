# Idea 006: USDCHF Regime-aware momentum

## Summary

Document a PyP Quant strategy candidate for USDCHF on 5m candles using a RandomForestClassifier approach focused on regime-aware momentum.

## Market Hypothesis

USDCHF may show repeatable behavior when regime-aware momentum conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
