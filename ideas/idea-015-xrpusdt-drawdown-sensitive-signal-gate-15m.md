# Idea 015: XRPUSDT Drawdown-sensitive signal gate

## Summary

Document a PyP Quant strategy candidate for XRPUSDT on 15m candles using a XGBoost approach focused on drawdown-sensitive signal gate.

## Market Hypothesis

XRPUSDT may show repeatable behavior when drawdown-sensitive signal gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
