# Idea 039: EURGBP Drawdown-sensitive signal gate

## Summary

Document a PyP Quant strategy candidate for EURGBP on 5m candles using a HistGradientBoostingClassifier approach focused on drawdown-sensitive signal gate.

## Market Hypothesis

EURGBP may show repeatable behavior when drawdown-sensitive signal gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
