# Idea 033: USDJPY Volume proxy divergence

## Summary

Document a PyP Quant strategy candidate for USDJPY on 1m candles using a LogisticRegression approach focused on volume proxy divergence.

## Market Hypothesis

USDJPY may show repeatable behavior when volume proxy divergence conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
