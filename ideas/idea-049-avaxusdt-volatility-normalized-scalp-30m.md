# Idea 049: AVAXUSDT Volatility-normalized scalp

## Summary

Document a PyP Quant strategy candidate for AVAXUSDT on 30m candles using a SGDClassifier approach focused on volatility-normalized scalp.

## Market Hypothesis

AVAXUSDT may show repeatable behavior when volatility-normalized scalp conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
