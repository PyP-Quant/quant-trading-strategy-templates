# Idea 026: NATGAS Session breakout confirmation

## Summary

Document a PyP Quant strategy candidate for NATGAS on 4h candles using a statsmodels ARIMA approach focused on session breakout confirmation.

## Market Hypothesis

NATGAS may show repeatable behavior when session breakout confirmation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
