# Idea 028: SPX500 Liquidity sweep reversal

## Summary

Document a PyP Quant strategy candidate for SPX500 on 4h candles using a rule-based baseline approach focused on liquidity sweep reversal.

## Market Hypothesis

SPX500 may show repeatable behavior when liquidity sweep reversal conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
