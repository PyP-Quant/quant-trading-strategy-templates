# Idea 076: ADAUSDT Liquidity sweep reversal

## Summary

Document a PyP Quant strategy candidate for ADAUSDT on 30m candles using a ExtraTreesClassifier approach focused on liquidity sweep reversal.

## Market Hypothesis

ADAUSDT may show repeatable behavior when liquidity sweep reversal conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
