# Idea 024: WTICOUSD Trend exhaustion classifier

## Summary

Document a PyP Quant strategy candidate for WTICOUSD on 1h candles using a CalibratedClassifierCV approach focused on trend exhaustion classifier.

## Market Hypothesis

WTICOUSD may show repeatable behavior when trend exhaustion classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
