# Idea 051: XAUUSD Volatility compression expansion

## Summary

Document a PyP Quant strategy candidate for XAUUSD on 1h candles using a SGDClassifier approach focused on volatility compression expansion.

## Market Hypothesis

XAUUSD may show repeatable behavior when volatility compression expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
