# Idea 038: GBPJPY Cross-asset confirmation

## Summary

Document a PyP Quant strategy candidate for GBPJPY on 5m candles using a HistGradientBoostingClassifier approach focused on cross-asset confirmation.

## Market Hypothesis

GBPJPY may show repeatable behavior when cross-asset confirmation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
