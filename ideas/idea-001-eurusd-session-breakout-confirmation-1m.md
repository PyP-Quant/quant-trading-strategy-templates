# Idea 001: EURUSD Session breakout confirmation

## Summary

Document a PyP Quant strategy candidate for EURUSD on 1m candles using a LogisticRegression approach focused on session breakout confirmation.

## Market Hypothesis

EURUSD may show repeatable behavior when session breakout confirmation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
