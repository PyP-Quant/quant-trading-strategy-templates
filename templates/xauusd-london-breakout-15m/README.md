# xauusd-london-breakout-15m

Gold London breakout baseline for PyP Quant Mode.

This is an educational starter template for `XAUUSD` on the `15m` timeframe. It implements the PyP Quant contract:
