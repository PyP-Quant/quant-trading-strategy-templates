# Idea 100: EURNZD Liquidity sweep reversal

## Summary

Document a PyP Quant strategy candidate for EURNZD on 5m candles using a LightGBM approach focused on liquidity sweep reversal.

## Market Hypothesis

EURNZD may show repeatable behavior when liquidity sweep reversal conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
