# Idea 056: NATGAS Range fade classifier

## Summary

Document a PyP Quant strategy candidate for NATGAS on 4h candles using a statsmodels ARIMA approach focused on range fade classifier.

## Market Hypothesis

NATGAS may show repeatable behavior when range fade classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
