# Idea 094: AUDUSD ATR trailing exit study

## Summary

Document a PyP Quant strategy candidate for AUDUSD on 1m candles using a RandomForestClassifier approach focused on ATR trailing exit study.

## Market Hypothesis

AUDUSD may show repeatable behavior when ATR trailing exit study conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
