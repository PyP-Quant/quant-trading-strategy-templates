# Idea 054: WTICOUSD Mean reversion with ATR bands

## Summary

Document a PyP Quant strategy candidate for WTICOUSD on 1h candles using a CalibratedClassifierCV approach focused on mean reversion with ATR bands.

## Market Hypothesis

WTICOUSD may show repeatable behavior when mean reversion with ATR bands conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
...
- Predict whether the forward 1h move exceeds an ATR-normalized threshold.
