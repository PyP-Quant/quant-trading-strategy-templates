# Idea 017: DOGEUSDT Bollinger squeeze expansion

## Summary

Document a PyP Quant strategy candidate for DOGEUSDT on 30m candles using a ExtraTreesClassifier approach focused on Bollinger squeeze expansion.

## Market Hypothesis

DOGEUSDT may show repeatable behavior when Bollinger squeeze expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
