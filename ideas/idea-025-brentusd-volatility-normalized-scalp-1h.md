# Idea 025: BRENTUSD Volatility-normalized scalp

## Summary

Document a PyP Quant strategy candidate for BRENTUSD on 1h candles using a statsmodels ARIMA approach focused on volatility-normalized scalp.

## Market Hypothesis

BRENTUSD may show repeatable behavior when volatility-normalized scalp conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
