# Idea 082: XAGUSD Volume proxy divergence

## Summary

Document a PyP Quant strategy candidate for XAGUSD on 1h candles using a CalibratedClassifierCV approach focused on volume proxy divergence.

## Market Hypothesis

XAGUSD may show repeatable behavior when volume proxy divergence conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
