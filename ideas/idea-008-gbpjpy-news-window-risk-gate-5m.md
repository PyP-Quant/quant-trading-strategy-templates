# Idea 008: GBPJPY News-window risk gate

## Summary

Document a PyP Quant strategy candidate for GBPJPY on 5m candles using a HistGradientBoostingClassifier approach focused on news-window risk gate.

## Market Hypothesis

GBPJPY may show repeatable behavior when news-window risk gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
