# Idea 072: ETHUSDT Trend exhaustion classifier

## Summary

Document a PyP Quant strategy candidate for ETHUSDT on 15m candles using a LightGBM approach focused on trend exhaustion classifier.

## Market Hypothesis

ETHUSDT may show repeatable behavior when trend exhaustion classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
