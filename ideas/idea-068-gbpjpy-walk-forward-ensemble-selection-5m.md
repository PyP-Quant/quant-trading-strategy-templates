# Idea 068: GBPJPY Walk-forward ensemble selection

## Summary

Document a PyP Quant strategy candidate for GBPJPY on 5m candles using a HistGradientBoostingClassifier approach focused on walk-forward ensemble selection.

## Market Hypothesis

GBPJPY may show repeatable behavior when walk-forward ensemble selection conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
