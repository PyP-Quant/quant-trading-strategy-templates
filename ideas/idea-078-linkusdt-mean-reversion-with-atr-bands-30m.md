# Idea 078: LINKUSDT Mean reversion with ATR bands

## Summary

Document a PyP Quant strategy candidate for LINKUSDT on 30m candles using a ExtraTreesClassifier approach focused on mean reversion with ATR bands.

## Market Hypothesis

LINKUSDT may show repeatable behavior when mean reversion with ATR bands conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
...
- Predict whether the forward 30m move exceeds an ATR-normalized threshold.
