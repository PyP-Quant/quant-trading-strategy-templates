# Idea 091: EURUSD Calendar seasonality overlay

## Summary

Document a PyP Quant strategy candidate for EURUSD on 1m candles using a LogisticRegression approach focused on calendar seasonality overlay.

## Market Hypothesis

EURUSD may show repeatable behavior when calendar seasonality overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
