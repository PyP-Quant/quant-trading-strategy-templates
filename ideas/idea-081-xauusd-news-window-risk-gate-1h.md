# Idea 081: XAUUSD News-window risk gate

## Summary

Document a PyP Quant strategy candidate for XAUUSD on 1h candles using a SGDClassifier approach focused on news-window risk gate.

## Market Hypothesis

XAUUSD may show repeatable behavior when news-window risk gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
