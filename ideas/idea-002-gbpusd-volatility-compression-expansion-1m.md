# Idea 002: GBPUSD Volatility Compression Expansion

## Summary

Document a PyP Quant strategy candidate for GBPUSD on 1m candles using a LogisticRegression approach focused on volatility compression expansion.

## Market Hypothesis

GBPUSD may show repeatable behavior when volatility compression expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
