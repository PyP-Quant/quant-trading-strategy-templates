# Idea 086: NATGAS Carry-aware trend overlay

## Summary

Document a PyP Quant strategy candidate for NATGAS on 4h candles using a statsmodels ARIMA approach focused on carry-aware trend overlay.

## Market Hypothesis

NATGAS may show repeatable behavior when carry-aware trend overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
