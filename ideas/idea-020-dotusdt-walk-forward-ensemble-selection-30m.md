# Idea 020: DOTUSDT Walk-forward ensemble selection

## Summary

Document a PyP Quant strategy candidate for DOTUSDT on 30m candles using a SGDClassifier approach focused on walk-forward ensemble selection.

## Market Hypothesis

DOTUSDT may show repeatable behavior when walk-forward ensemble selection conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
