# Idea 071: BTCUSDT False breakout detector

## Summary

Document a PyP Quant strategy candidate for BTCUSDT on 15m candles using a LightGBM approach focused on false breakout detector.

## Market Hypothesis

BTCUSDT may show repeatable behavior when false breakout detector conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
