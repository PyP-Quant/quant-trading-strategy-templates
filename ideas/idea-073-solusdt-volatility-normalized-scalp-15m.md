# Idea 073: SOLUSDT Volatility-normalized scalp

## Summary

Document a PyP Quant strategy candidate for SOLUSDT on 15m candles using a XGBoost approach focused on volatility-normalized scalp.

## Market Hypothesis

SOLUSDT may show repeatable behavior when volatility-normalized scalp conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
