# Idea 005: USDCAD Mean reversion with ATR bands

## Summary

Document a PyP Quant strategy candidate for USDCAD on 1m candles using a RandomForestClassifier approach focused on mean reversion with ATR bands.

## Market Hypothesis

USDCAD may show repeatable behavior when mean reversion with ATR bands conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
