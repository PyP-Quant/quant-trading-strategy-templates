# Idea 047: DOGEUSDT False breakout detector

## Summary

Document a PyP Quant strategy candidate for DOGEUSDT on 30m candles using a ExtraTreesClassifier approach focused on false breakout detector.

## Market Hypothesis

DOGEUSDT may show repeatable behavior when false breakout detector conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
