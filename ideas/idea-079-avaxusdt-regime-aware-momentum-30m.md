# Idea 079: AVAXUSDT Regime-aware momentum

## Summary

Document a PyP Quant strategy candidate for AVAXUSDT on 30m candles using a SGDClassifier approach focused on regime-aware momentum.

## Market Hypothesis

AVAXUSDT may show repeatable behavior when regime-aware momentum conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
