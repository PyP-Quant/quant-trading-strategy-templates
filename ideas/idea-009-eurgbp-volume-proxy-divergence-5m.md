# Idea 009: EURGBP Volume proxy divergence

## Summary

Document a PyP Quant strategy candidate for EURGBP on 5m candles using a HistGradientBoostingClassifier approach focused on volume proxy divergence.

## Market Hypothesis

EURGBP may show repeatable behavior when volume proxy divergence conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
