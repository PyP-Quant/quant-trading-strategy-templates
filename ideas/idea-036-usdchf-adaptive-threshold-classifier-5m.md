# Idea 036: USDCHF Adaptive threshold classifier

## Summary

Document a PyP Quant strategy candidate for USDCHF on 5m candles using a RandomForestClassifier approach focused on adaptive threshold classifier.

## Market Hypothesis

USDCHF may show repeatable behavior when adaptive threshold classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
