# Idea 097: EURJPY Volatility-normalized scalp

## Summary

Document a PyP Quant strategy candidate for EURJPY on 5m candles using a HistGradientBoostingClassifier approach focused on volatility-normalized scalp.

## Market Hypothesis

EURJPY may show repeatable behavior when volatility-normalized scalp conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
