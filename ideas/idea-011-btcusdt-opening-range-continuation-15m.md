# Idea 011: BTCUSDT Opening range continuation

## Summary

Document a PyP Quant strategy candidate for BTCUSDT on 15m candles using a LightGBM approach focused on opening range continuation.

## Market Hypothesis

BTCUSDT may show repeatable behavior when opening range continuation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
