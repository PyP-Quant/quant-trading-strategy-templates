# Idea 040: EURNZD RSI failure swing filter

## Summary

Document a PyP Quant strategy candidate for EURNZD on 5m candles using a LightGBM approach focused on RSI failure swing filter.

## Market Hypothesis

EURNZD may show repeatable behavior when RSI failure swing filter conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
