# Idea 042: ETHUSDT Market structure retest

## Summary

Document a PyP Quant strategy candidate for ETHUSDT on 15m candles using a LightGBM approach focused on market structure retest.

## Market Hypothesis

ETHUSDT may show repeatable behavior when market structure retest conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
