# Idea 023: XPTUSD False breakout detector

## Summary

Document a PyP Quant strategy candidate for XPTUSD on 1h candles using a CalibratedClassifierCV approach focused on false breakout detector.

## Market Hypothesis

XPTUSD may show repeatable behavior when false breakout detector conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
