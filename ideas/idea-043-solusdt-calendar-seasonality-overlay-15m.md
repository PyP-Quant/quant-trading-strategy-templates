# Idea 043: SOLUSDT Calendar seasonality overlay

## Summary

Document a PyP Quant strategy candidate for SOLUSDT on 15m candles using a XGBoost approach focused on calendar seasonality overlay.

## Market Hypothesis

SOLUSDT may show repeatable behavior when calendar seasonality overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
