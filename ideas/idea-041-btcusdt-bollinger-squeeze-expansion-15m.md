# Idea 041: BTCUSDT Bollinger squeeze expansion

## Summary

Document a PyP Quant strategy candidate for BTCUSDT on 15m candles using a LightGBM approach focused on Bollinger squeeze expansion.

## Market Hypothesis

BTCUSDT may show repeatable behavior when Bollinger squeeze expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
