# Idea 052: XAGUSD Liquidity sweep reversal

## Summary

Document a PyP Quant strategy candidate for XAGUSD on 1h candles using a CalibratedClassifierCV approach focused on liquidity sweep reversal.

## Market Hypothesis

XAGUSD may show repeatable behavior when liquidity sweep reversal conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
