# Idea 044: BNBUSDT Walk-forward ensemble selection

## Summary

Document a PyP Quant strategy candidate for BNBUSDT on 15m candles using a XGBoost approach focused on walk-forward ensemble selection.

## Market Hypothesis

BNBUSDT may show repeatable behavior when walk-forward ensemble selection conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
