# Idea 064: AUDUSD RSI failure swing filter

## Summary

Document a PyP Quant strategy candidate for AUDUSD on 1m candles using a RandomForestClassifier approach focused on RSI failure swing filter.

## Market Hypothesis

AUDUSD may show repeatable behavior when RSI failure swing filter conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
