# Idea 007: EURJPY Range fade classifier

## Summary

Document a PyP Quant strategy candidate for EURJPY on 5m candles using a HistGradientBoostingClassifier approach focused on range fade classifier.

## Market Hypothesis

EURJPY may show repeatable behavior when range fade classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
