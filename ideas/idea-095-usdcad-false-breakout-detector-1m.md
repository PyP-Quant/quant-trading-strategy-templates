# Idea 095: USDCAD False breakout detector

## Summary

Document a PyP Quant strategy candidate for USDCAD on 1m candles using a RandomForestClassifier approach focused on false breakout detector.

## Market Hypothesis

USDCAD may show repeatable behavior when false breakout detector conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
