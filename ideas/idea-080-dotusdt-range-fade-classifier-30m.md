# Idea 080: DOTUSDT Range fade classifier

## Summary

Document a PyP Quant strategy candidate for DOTUSDT on 30m candles using a SGDClassifier approach focused on range fade classifier.

## Market Hypothesis

DOTUSDT may show repeatable behavior when range fade classifier conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
