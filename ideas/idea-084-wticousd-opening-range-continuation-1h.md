# Idea 084: WTICOUSD Opening range continuation

## Summary

Document a PyP Quant strategy candidate for WTICOUSD on 1h candles using a CalibratedClassifierCV approach focused on opening range continuation.

## Market Hypothesis

WTICOUSD may show repeatable behavior when opening range continuation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
