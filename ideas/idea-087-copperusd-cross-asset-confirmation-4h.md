# Idea 087: COPPERUSD Cross-asset confirmation

## Summary

Document a PyP Quant strategy candidate for COPPERUSD on 4h candles using a statsmodels ARIMA approach focused on cross-asset confirmation.

## Market Hypothesis

COPPERUSD may show repeatable behavior when cross-asset confirmation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
