# Idea 057: COPPERUSD News-window risk gate

## Summary

Document a PyP Quant strategy candidate for COPPERUSD on 4h candles using a statsmodels ARIMA approach focused on news-window risk gate.

## Market Hypothesis

COPPERUSD may show repeatable behavior when news-window risk gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
