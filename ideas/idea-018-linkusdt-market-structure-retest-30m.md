# Idea 018: LINKUSDT Market structure retest

## Summary

Document a PyP Quant strategy candidate for LINKUSDT on 30m candles using a ExtraTreesClassifier approach focused on market structure retest.

## Market Hypothesis

LINKUSDT may show repeatable behavior when market structure retest conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
