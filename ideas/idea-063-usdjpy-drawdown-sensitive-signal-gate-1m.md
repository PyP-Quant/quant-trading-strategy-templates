# Idea 063: USDJPY Drawdown-sensitive signal gate

## Summary

Document a PyP Quant strategy candidate for USDJPY on 1m candles using a LogisticRegression approach focused on drawdown-sensitive signal gate.

## Market Hypothesis

USDJPY may show repeatable behavior when drawdown-sensitive signal gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
