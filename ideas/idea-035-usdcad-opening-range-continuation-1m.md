# Idea 035: USDCAD Opening range continuation

## Summary

Document a PyP Quant strategy candidate for USDCAD on 1m candles using a RandomForestClassifier approach focused on opening range continuation.

## Market Hypothesis

USDCAD may show repeatable behavior when opening range continuation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
