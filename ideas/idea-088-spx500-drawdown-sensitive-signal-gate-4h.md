# Idea 088: SPX500 Drawdown-sensitive signal gate

## Summary

Document a PyP Quant strategy candidate for SPX500 on 4h candles using a rule-based baseline approach focused on drawdown-sensitive signal gate.

## Market Hypothesis

SPX500 may show repeatable behavior when drawdown-sensitive signal gate conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
