# Idea 046: ADAUSDT ATR trailing exit study

## Summary

Document a PyP Quant strategy candidate for ADAUSDT on 30m candles using a ExtraTreesClassifier approach focused on ATR trailing exit study.

## Market Hypothesis

ADAUSDT may show repeatable behavior when ATR trailing exit study conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
