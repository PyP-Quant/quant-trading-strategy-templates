# Idea 037: EURJPY Carry-aware trend overlay

## Summary

Document a PyP Quant strategy candidate for EURJPY on 5m candles using a HistGradientBoostingClassifier approach focused on carry-aware trend overlay.

## Market Hypothesis

EURJPY may show repeatable behavior when carry-aware trend overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
