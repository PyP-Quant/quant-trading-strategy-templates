# Idea 067: EURJPY Calendar seasonality overlay

## Summary

Document a PyP Quant strategy candidate for EURJPY on 5m candles using a HistGradientBoostingClassifier approach focused on calendar seasonality overlay.

## Market Hypothesis

EURJPY may show repeatable behavior when calendar seasonality overlay conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
