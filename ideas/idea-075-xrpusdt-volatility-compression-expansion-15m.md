# Idea 075: XRPUSDT Volatility compression expansion

## Summary

Document a PyP Quant strategy candidate for XRPUSDT on 15m candles using a XGBoost approach focused on volatility compression expansion.

## Market Hypothesis

XRPUSDT may show repeatable behavior when volatility compression expansion conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
...
- Predict whether the forward 15m move exceeds an ATR-normalized threshold.
