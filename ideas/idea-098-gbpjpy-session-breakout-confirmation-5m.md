# Idea 098: GBPJPY Session breakout confirmation

## Summary

Document a PyP Quant strategy candidate for GBPJPY on 5m candles using a HistGradientBoostingClassifier approach focused on session breakout confirmation.

## Market Hypothesis

GBPJPY may show repeatable behavior when session breakout confirmation conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
