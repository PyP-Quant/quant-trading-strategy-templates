# Idea 022: XAGUSD ATR trailing exit study

## Summary

Document a PyP Quant strategy candidate for XAGUSD on 1h candles using a CalibratedClassifierCV approach focused on ATR trailing exit study.

## Market Hypothesis

XAGUSD may show repeatable behavior when ATR trailing exit study conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
