# Idea 016: ADAUSDT RSI failure swing filter

## Summary

Document a PyP Quant strategy candidate for ADAUSDT on 30m candles using a ExtraTreesClassifier approach focused on RSI failure swing filter.

## Market Hypothesis

ADAUSDT may show repeatable behavior when RSI failure swing filter conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
