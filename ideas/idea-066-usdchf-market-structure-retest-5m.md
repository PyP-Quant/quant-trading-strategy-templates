# Idea 066: USDCHF Market structure retest

## Summary

Document a PyP Quant strategy candidate for USDCHF on 5m candles using a RandomForestClassifier approach focused on market structure retest.

## Market Hypothesis

USDCHF may show repeatable behavior when market structure retest conditions align with volatility, trend, and recent structure filters. The first implementation should stay conservative and treat this as an educational research candidate, not a production trading recommendation.
